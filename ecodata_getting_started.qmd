...
# Getting Started with ECODATA
  ...
  - <a href="" target="_blank">ECODATA</a> is an R package for downloading economic data from FRED and World Bank, making reproducible, professional-quality data visualizations, and documenting your data sources

  - Makes this easy, with only two or three lines of code
